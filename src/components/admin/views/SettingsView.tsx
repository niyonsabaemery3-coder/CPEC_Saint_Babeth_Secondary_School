...
import PageBannerPanel from "../settings/PageBannerPanel";
...
const MENU: { key: SettingsSection; icon: string; title: string; desc: string; iconClass?: string }[] = [
  ...
  { key: "registration", icon: "fa-user-plus", title: "Self-Registration", desc: "Allow students/teachers to create their own account" },
