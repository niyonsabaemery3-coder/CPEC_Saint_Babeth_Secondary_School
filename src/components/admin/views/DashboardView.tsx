...
export default function DashboardView() {
  ...
  const pendingAccounts = teacherAccounts.filter((t) => t.status === "pending").length;
  ...
  return (
    <div className="admin-panel-view active">
      <div className="stat-grid">
        ...
        <div className="stat-card">
          <div className="num">{pendingAccounts}</div>
          <div className="lbl">Teacher accounts awaiting approval</div>
        </div>
      </div>
